...
/*
	Copyright (c) Baidu Youa Wed QWrap
	version: $version$ 2011-11-2$release$ released
	...
	var NodeH = {
		...
		*/
		tmpl : function(el, data){
			el = g(el);
                        var str = el.tagName === "SCRIPT" ? el.text : el.tagName === "TEXTAREA" ? el.value : el.innerHTML;//by 司徒正美 2011.1.11
			return StringH.tmpl(str, data);
		}
	};
