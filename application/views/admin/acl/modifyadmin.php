                    ...
                    <td>
    				    ...
    				    <?php foreach (Controller_Admin::$resources as $resource => $resName) { ?>
    				    	<li>
    				            ...
    				            <input type="checkbox" name="<?php echo $resource ?>_privileges[]" value="<?php echo $privilege ?>" <?php echo (isset($resources[$resource]) && isset($resources[$resource][$privilege]) && $resources[$resource][$privilege]) ? 'checked="checked"' : '' ?>> <?php echo $privName ?>
    				            <?php } ?>
    				            <?php } ?>
    				    	</li>
    				    <?php } ?>
