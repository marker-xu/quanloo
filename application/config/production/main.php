...
// 域名常量
define('DOMAIN_SITE', 'www.quanloo.com'); // 站点域名
define('DOMAIN_STATIC', 'static.quanloostatic.com'); // 静态资源域名
...
define('DOMAIN_API', 'api.quanloo.com'); // API子域名
define('DOMAIN_API_STATIC', 'static10.quanloostatic.com'); // API静态资源域名
