...
// 域名常量
define('DOMAIN_SITE', 'dev.quanloo.com:8181'); // 站点域名
define('DOMAIN_STATIC', 'dev.static.quanloo.sii.sdo.com:8181'); // 静态资源域名
...
define('DOMAIN_IMAGE_USER_AVATAR', 'dev.img.quanloo.sii.sdo.com:9222'); // 用户头像域名
define('DOMAIN_WEB_STORAGE_CLUSTER', 'dev.img.quanloo.sii.sdo.com:9222'); // WEB存储集群域名
define('DOMAIN_API', 'dev.quanloo.com:8181'); // API子域名
define('DOMAIN_API_STATIC', 'dev.static.quanloo.sii.sdo.com:8181'); // API静态资源域名
